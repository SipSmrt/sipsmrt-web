...
const fragment = /* glsl */ `
    ...
    void main() {
        ...
        gl_FragColor = vec4(vColor.rgb * uBrightness, vColor.a * circle);
    }
`;
...
const Particles: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const camera_distance = isMobile ? 10 : 20;
    ...
    const spread = 10;
    const speed = 0.1;
    const baseSize = isMobile ? 600 : 400;
    const sizeRandomness = 0.0;
    const disableRotation = true;

    const palette = ["#31ADFFB6", "#21A7F0AA", "#2188F02E"];
    ...
    program.uniforms.uBrightness = { value: isMobile ? 0.7 : 1.0 };
